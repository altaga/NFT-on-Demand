                    ...
                    <Row style={{ fontSize: "1.2rem" }}>
                        ...
                        <Col>
                            ...
                            <div className="flexbox-style">
                                ...
                                <div>
                                    <Button style={{ width: "12vw", borderRadius: "0px 25px 25px 0px", fontSize: "1.5rem", background: `rgb(255,128,0)` }}>
                                        Subscribe
                                    </Button>
                                </div>
                            </div>
                    ...
                    <Row>
                        ...
                        <Col>
                            <div style={{ color: "white", fontWeight: "bolder", fontSize: "1.7rem", width: "40vw" }}>
                                NFT on Demand is a marketplace that connects users with real NFT artists,
                                where you can order the content you want to have.
                            </div>
                        </Col>
                        <Col>
                            {""}
