                ...
                <Row style={{ fontSize: "1.2rem" }}>
                    ...
                    </Col>
                    {
                        this.props.my_pubkey.pubkey !== "" ?
                            <Col style={{ paddingTop: "8px" }}>
                                <a className="nostyle" href="/order">
                                    Order your NFT
                                </a>
                            </Col>
                            :
                    ...
                    <Col>
                        <Button onClick={this.enableEthereum} style={{ width: "200px", borderRadius: "25px", fontSize: "1.2rem", background: ` rgb(255,128,0)` }} color="primary">{
                            this.props.my_pubkey.pubkey !== "" ?
                                "Connected"
                                :
                                "Connect Wallet"
